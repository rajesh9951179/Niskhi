...
const products = [
  { id: 1, img: img01, title: 'Imported VR Box', details: '35px 5D (Model 2023)', categories: ['Entertainment', 'Electronics'], status: 'In stock', attributes: { color: ['#000', '#6c757d'], size: 'M' }, price: { current: 129, original: 200 }, date: '05 Aug 2023' },
